...
public class Payment {
    ...
    protected Payment() {}
    public Payment(Order order, Employee cashier, Method method, BigDecimal amount) { this.order=order; this.cashier=cashier; this.method=method; this.amount=amount; }
}
